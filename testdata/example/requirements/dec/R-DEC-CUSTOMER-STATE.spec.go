...
var RDecCustomerState = spec.Declare(spec.Requirement{
...
already carried by the quote. Keeping every correction as a fact would make the
common read — who is this customer now — the expensive one.`,
